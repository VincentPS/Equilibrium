...
function handleDragEvent() {
    $(".draggable").mouseup(function() {
        var windowWidth = parseInt(window.innerWidth, 10),
            ...
            xPos1Min = windowWidth - combinerRight - combinerWidth + 56,
            xPos1Max = windowWidth - combinerRight - combinerWidth + 195,
            yPos1Min = windowHeight - combinerBottom - combinerHeight + 34,
            yPos1Max = windowHeight - combinerBottom - combinerHeight + 337,
            xPos2Min = windowWidth - combinerRight - combinerWidth + 348,
            xPos2Max = windowWidth - combinerRight - combinerWidth + 487,
            yPos2Min = windowHeight - combinerBottom - combinerHeight + 34,
            yPos2Max = windowHeight - combinerBottom - combinerHeight + 337,
            imagePos = $(".draggable").position(),
